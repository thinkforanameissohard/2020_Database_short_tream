...
<body>
	<div id="wrapper" class="wrapper">
		...
		<h1>
			学生成绩管理<span>Welcome to our system</span>
		</h1>
		</header>
		<main>
		<div class="container">
			<div class="btn-wrapper">
				...
				<div class="btn-group">
					...
					</a> <a href="javascript:void(0)" onclick="displayWindow1()"
						class="btn btn-default btn-sm"> <span
						class="glyphicon glyphicon-th"></span>添加
					</a>
				</div>
			</div>
			...
			<div id="window1" class="window_css">
				<form action="tginsert.do" method="post">
					...
					<table id="table2">
						...
						<tr>
							<th>教学内容：</th>
							<td><input name="ccontent" style="width: 200px;"
								class="input2 Safe" type="text" value=""></input></td>
						</tr>
						<tr>
			...
			<div id="products" class="row list-group">
				<%
						...
						%>
				<form class="change" action="tgeditsave.do"
					onsubmit="return is_empty()" method="post">
					<table id="table" style="width: 100px">
						<tr>
							<th width="30%">学号：</th>
							<td width="70%"><input name="sno" class="input2 Safe"
								type="text" value="<%=bi.getSno()%>" readonly></input></td>
						</tr>
						<tr>
							<th width="30%">成绩：</th>
							<td width="70%"><input name="results" class="input2 Safe"
								type="text" value="<%=bi.getResults()%>"></input></td>
						</tr>
						<tr>
							<th>课程号：</th>
							<td><input name="cno" class="input2 Safe" type="text"
								value="<%=bi.getCno()%>" readonly></input></td>
						</tr>
						<tr>
							<th>教学内容：</th>
							<td><input name="ccontent" class="input2 Safe" type="text"
								value="<%=bi.getCcontent()%>"></input></td>
						</tr>
						<tr>
							<th></th>
