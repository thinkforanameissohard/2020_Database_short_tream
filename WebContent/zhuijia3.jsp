		...
		<div class="response-group">
			<div class="response">
				...
				<div class="post-group">
                    ...
                    String s = " select * from bbs2 where bbs2.bno1 =(select  bno from bbs1 where btime in(select btime from (select * from bbs1 order by btime desc limit 3) as t3)order by btime asc limit 1) ORDER BY btime DESC ";
