...
<nav id="mm-menu" class="mm-menu">
	...
	<ul class="mm-menu__items">
		<li class="mm-menu__item"><a class="mm-menu__link"
			href='index.do'> <span class="mm-menu__link-text"><i
					class="md md-home"></i>主页</span>
		</a></li>
		<%    		
  			...
  			else
  			{
  				out.print(
  						"<li class=\"mm-menu__item\">"
					      	+"<a class=\"mm-menu__link\" href=\"sbase.jsp\">"
					        	+"<span class=\"mm-menu__link-text\"><i class=\"md md-inbox\"></i>我的作业</span>"
					      	+"</a>"
					      +"</li>");
  			}
	 	  %>
		<li class="mm-menu__item"><a class="mm-menu__link" href="self.do">
