...
<!-- 老师可以在发布课程大纲、教学计划、每堂课的教学内容、课程学分等 
	...
	<div id="wrapper" class="wrapper">
		<header class="header htmleaf-header">
			<h1>作业信息管理<span>Welcome to our system</span></h1>
		</header>
	  <main>
				<div class="container">
					...
					<div id="products" class="row list-group">
						...
						%>
								...
								<form class="change" action="theditsave.do"  onsubmit="return is_empty()" method="post">
									<table id="table" style="width:800px;">
										...
										<tr>
											...
											<td width="70%">
												<input  name="hname"  class="input2 Safe" type="text" value="<%=bi.getName()%>" readonly></input>
											</td>
										</tr>
										<tr>
											<th>课程号：</th>
										...
										<tr>
											<th>上传时间：</th>
											<td>
												<input  name="htime" class="input2 Safe" type="date" value="<%=bi.getHtime()%>" readonly></input>
											</td>
										</tr>
										<tr>
											<th>作业内容：</th>
											<td>
												<textarea class="input2 Safe" name="hcoutent" ><%=bi.getHcontent()%></textarea>
											</td>
										</tr>
										<tr>
											<th></th>
