...
<body>
	...
	<div id="wrapper" class="wrapper">
		...
		<h1>
			作业信息管理<span>Welcome to our system</span>
		</h1>
		</header>
		<main>
		<div class="container">
			...
			<div id="products" class="row list-group">
				<%
						...
						if(request.getParameter("cno")!=null&&request.getParameter("sno")!=null)
						{
							Homework bi = (Homework) request.getAttribute("bi");
						%>

				<form class="change" action="theditsave.do"
					...
					<table id="table" style="width: 800px;">
						...
						<tr>
							<th width="30%">上传者姓名：</th>
							<td width="70%"><input name="hname" class="input2 Safe"
								type="text" value="<%=bi.getName()%>" readonly></input></td>
						</tr>
						<tr>
							<th>课程号：</th>
						...
						<tr>
							<th>上传时间：</th>
							<td><input name="htime" class="input2 Safe" type="date"
								value="<%=bi.getHtime()%>" readonly></input></td>
						</tr>
						<tr>
							<th>作业内容：</th>
							<td><textarea class="input2 Safe" name="hcoutent"><%=bi.getHcontent()%></textarea>
							</td>
						</tr>
						<tr>
							<th></th>
									...
									out.print("<div class=\"item  col-xs-4 col-lg-4\">"+
										        ...
										        "<div class=\"caption\">"+
										            "<h4 class=\"group inner list-group-item-heading\">"+bi.getSno()+"</h4>"+
														"<ul>"+
															"<li>上传者姓名："+bi.getName()+"</li>"+
															"<li>课程号："+bi.getCno()+"</li>"+
															"<li>上传时间："+bi.getHtime()+"</li>"+
															"<li>作业内容："+bi.getHcontent()+"</li>"+
														"</ul>"+
										            "<div class=\"row\">"+
										                "<div class=\"col-xs-12 col-md-6\">"+
										                    "<a class=\"btn btn-success\"  onclick=\"displayWindow()\" href=\"thomework.do?cno="+bi.getCno()+"&sno="+bi.getSno()+"\">修改</a>"+
										                "</div>"+
														"<div class=\"col-xs-12 col-md-6\">"+
														    "<a class=\"btn btn-success\" href=\"thdel.do?cno="+bi.getCno()+"&sno="+bi.getSno()+"\">删除</a>"+
														"</div>"+
										            "</div>"+
										        "</div>"+
										      "</div>"+
