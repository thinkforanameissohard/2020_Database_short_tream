	...
	<div id="window1" class="window_css">		
		<form action="sinsert.do" method="post">
			...
			<table style="width:50%" id="table">
				...
				<tr>
					<th width="30%">密码：</th>
					<td width="70%"><input id="uname" name="password" type="text" value=""></td>
				</tr>
				<tr>
					<th width="30%">姓名：</th>
					<td width="70%"><input id="uname" name="sname" type="text" value=""></td>
				</tr>
				<tr>
					<th>年龄：</th>
	...
	<div id="window2" class="window_css">		
		<form action="tinsert.do" method="post">
			...
			<table style="width:50%" id="table">
				<tr>
					<th width="30%">工号：</th>
					<td width="70%"><input id="uname" name="tno" type="text" value=""></td>
				</tr>
				<tr>
					<th width="30%">密码：</th>
					<td width="70%"><input id="uname" name="password" type="text" value=""></td>
				...
				<tr>
					<th width="30%">姓名：</th>
					<td width="70%"><input id="uname" name="tname" type="text" value=""></td>
				</tr>
				<tr>
					<th>年龄：</th>
