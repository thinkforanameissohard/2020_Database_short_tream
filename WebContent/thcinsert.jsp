	...
	<div id="window1" class="window_css">
		<form action="thinsert.do" method="post">
			...
			<table id="table">
				<tr>
					<th width="30%">课程号：</th>
					<td width="70%"><input id="uname" name="cno" type="text"
						value=""></td>
				</tr>
				<tr>
					<th width="30%">学号：</th>
	...
	<div id="window2" class="window_css">
		<form action="tcinsert.do" method="post">
			...
			<table id="table">
				<tr>
					<th width="30%">课程名字：</th>
					<td width="70%"><input name="cname" class="input2 Safe"
				...
				<tr>
					<th>学分：</th>
					<td><input name="credits" class="input2 Safe" type="text"
						value=""></input></td>
				</tr>

				<tr>
					<th>教学计划：</th>
					<td><textarea class="input2 Safe" name="cplan"></textarea></td>
				</tr>
				<tr>
					<th>大纲：</th>
					<td><textarea class="input2 Safe" name="coutline"></textarea>
					</td>
				</tr>
				<tr>
					<th></th>
					<td><input type="hidden" name="tno" value=""></input></td>
				</tr>
				<tr>
					<th></th>
					<td><input type="submit" class="input1" value="修改"></input> <input
						type="reset" value="重置"></input></td>
				</tr>
			</table>
		</form>
