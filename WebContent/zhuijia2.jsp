...
.post__actions .button:not (.comment ):hover, .post__actions .button:not
	(.comment ).active {
	background-color: #fff;
	cursor: pointer;
}

.post__actions .button:not (.comment ):hover i.solid, .post__actions .button:not
	(.comment ).active i.solid {
	display: inline-block;
}
...
<script src="//wow.techbrood.com/libs/jquery/jquery-2.1.1.min.js"></script>
</head>
<body>
	<%
		...
		<div class="response-group">
			<div class="response">
				...
				<div class="post-group">
                    ...
                    String s = " select * from bbs2 where bbs2.bno1 =(select  bno from bbs1 where btime in(select btime from (select * from bbs1 order by btime desc limit 2) as t3)order by btime asc limit 1)ORDER BY btime DESC ";
