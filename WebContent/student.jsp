...
<body>
	<div id="wrapper" class="wrapper">
		...
		<h1>
			学生信息管理<span>Welcome to our system</span>
		</h1>
		</header>
		<main>
		<div class="container">
			...
			<div id="products" class="row list-group">
				...
				<form class="change" action="seditsave.do"
					onsubmit="return is_empty()" method="get">
					<table id="table" style="width: 50%">
						<tr>
							<th width="30%">姓名：</th>
							<td width="70%"><input name="sname" class="input2 Safe"
								type="text" value="<%=bi.getSname()%>"></input></td>
						</tr>
						<tr>
							<th width="30%">密码：</th>
						...
						<tr>
							<th>年龄：</th>
							<td><input name="sage" class="input2 Safe" type="text"
								value="<%=bi.getSage()%>"></input></td>
						</tr>
						<tr>
							<th>生日：</th>
							<td><input name="sbirth" class="input2 Safe" type="date"
								value="<%=bi.getSbirth()%>"></input></td>
						</tr>
						<tr>
							<th>地址：</th>
							<td><input name="saddress" class="input2 Safe" type="text"
								value="<%=bi.getSaddress()%>"></input></td>
						</tr>
						<tr>
							<th></th>
							<td><input type="hidden" name="sno" value="<%=bi.getSno()%>"></input>
							</td>
						</tr>
						<tr>
							<th></th>
							...
							else
							{
								...
								for (Student bi : list)
								{
									...
									out.print("<div class=\"item  col-xs-4 col-lg-4\">"+
										        ...
										        "<div class=\"caption\">"+
										            "<h4 class=\"group inner list-group-item-heading\">"+bi.getSname()+"</h4>"+
														"<ul>"+
															"<li>学号："+bi.getSno()+"</li>"+
															"<li>密码："+bi.getPassword()+"</li>"+
															"<li>年龄："+bi.getSage()+"</li>"+
															"<li>生日："+bi.getSbirth()+"</li>"+
															"<li>家庭住址："+bi.getSaddress()+"</li>"+
														"</ul>"+
										            "<div class=\"row\">"+
										                "<div class=\"col-xs-12 col-md-6\">"+
										                    "<a class=\"btn btn-success\"  onclick=\"displayWindow()\" href=\"student.do?sno="+sno+"\">修改</a>"+
										                "</div>"+
														"<div class=\"col-xs-12 col-md-6\">"+
														    "<a class=\"btn btn-success\" href=\"sdel.do?sno="+sno+"\">删除</a>"+
														"</div>"+
										            "</div>"+
										        "</div>"+
										      "</div>"+
