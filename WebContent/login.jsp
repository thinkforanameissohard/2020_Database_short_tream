...
<link rel="stylesheet" href="css/style-search.css" media="screen"
	type="text/css" />
...
<body>
	...
	<div id="d" class="webdesigntuts-workshop">
		<form action="judge.do" method="post" onsubmit="return is_empty()">
			<p id="nid">
				<input id="name" value="请输入用户名" type="text" name="name" />
			</p>
			<p id="pid">
				<input id="pwd" value="请输入密码" type="password" name="password" />
			</p>
			<p id="iid">
				<input id="idd" value="请输入学号/工号" type="text" name="id" />
			</p>
