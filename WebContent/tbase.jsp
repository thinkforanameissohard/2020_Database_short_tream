...
<body>
	...
	<div id="wrapper" class="wrapper">
		...
		<h1>
			课程信息管理<span>Welcome to our system</span>
		</h1>
		</header>
		<main>
		<div class="container">
					...
					<table id="table" style="width: 800px;">
						<tr>
							...
							<td width="70%"><input name="cname" class="input2 Safe"
								type="text" value="<%=bi.getCname()%>"></input></td>
						</tr>
						<tr>
							<th width="30%">课程号：</th>
							<td width="70%"><input name="cno" class="input2 Safe"
								type="text" value="<%=bi.getCno()%>" readonly></input></td>
						</tr>
						<tr>
							<th>学分：</th>
							<td><input name="credits" class="input2 Safe" type="text"
								value="<%=bi.getCredits()%>"></input></td>
						</tr>

						<tr>
							<th>教学计划：</th>
							<td><textarea class="input2 Safe" name="cplan"><%=bi.getCplan()%></textarea>
							</td>
						</tr>
						<tr>
							<th>大纲：</th>
							<td><textarea class="input2 Safe" name="coutline"><%=bi.getCoutline()%></textarea>

							</td>
						</tr>
						<tr>
							<th></th>
							<td><input type="hidden" name="tno" value="<%=bi.getCno()%>"></input>
							</td>
						</tr>
						<tr>
							<th></th>
